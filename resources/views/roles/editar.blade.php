                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-4">
                                    ...
                                    {!! Form::text('name', null, array('class' => 'form-control', 'oninput' => 'capitalizarInput(name)', 'onkeypress' => 'return soloLetras(event);')) !!}
                                </div>
                            </div>
                        </div> 
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <?php $counter = 0; ?>  @foreach($permission as $value)
                                    <?php $counter++; ?> 
                                        <div class="form-check col-md-3">  <label class="form-check-label">
