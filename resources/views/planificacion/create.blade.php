...
@section('title', 'Asignar Planificación')
            ...
            <div class="card mb-4">
                ...
                <form method="post" action="{{ route('planificacion.store') }}" enctype="multipart/form-data" onsubmit="return Planificacion(this)">
                    ...
                    <div class="card-body">
                        ...
                        <input type="hidden" class="form-control" id="id_proyecto" name="id_proyecto" style="background: white;" value="{{ $proyecto->id }}" autocomplete="off">
