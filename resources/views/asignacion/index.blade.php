                            ...
                            <table class="table align-items-center table-flush" id="dataTable">
                                ...
                                <tbody>
                                    @foreach ($evaluaciones as $evaluacion)
                                        ...
                                        <td class="font-weight-bold text-dark">{{ $evaluacion->estatus_res }}</td> --}}
                                        ...
                                        <div style="display: flex; justify-content: center;">
                                         ...
                                         <td>
                                             ...
                                             {{-- <div style="display: flex; justify-content: center;">
                                                ...
                                                <a class="btn btn-danger btn-sm negar-solicitud" style="margin: 0 1px;" title="Negar Solicitud" data-evaluacion-id='{{ $evaluacion->id }}'>
