...
<title>@yield('title') Visita</title>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            ...
                            <h2 class="font-weight-bold text-dark">Gestión de Visita</h2>
                        ...
                        <table class="table align-items-center table-flush" id="dataTable">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th class="font-weight-bold text-dark">Visitas</th>
                            ...
                            <tbody>
                                @foreach ($visitas as $visita)  
                                     ...
                                     <td class="font-weight-bold text-dark">
                                         ...
                                         <td class="font-weight-bold text-dark">{{ $visita->comunidad->nom_comuni }}</td>
                                        ...
                                        <td>
                                            ...
                                            <div style="display: flex; justify-content: center;">
                                                ...
                                                @can('editar-visita')
                                                    <a class="btn btn-warning btn-sm" href="{{ route('visita.edit',$visita->id) }}"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
