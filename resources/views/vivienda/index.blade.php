...
<title>@yield('title') Viviendas</title>
        ...
        <div class="col-12 w-100">
            <div class="card mb-4 w-100">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <h2 class="font-weight-bold text-dark" style="margin-left: 6%;">Gestión de Viviendas</h2>
                    {{-- @can('crear-comisionado') --}}
                            <form action="{{ route('vivienda.create') }}" method="get" style="display:inline;">
                                <button type="submit" class="btn btn-primary btn-mb"> <span class="">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-vivienda-plus-fill" viewBox="0 0 16 16">
                    ...
                    <table class="table align-items-center table-flush" id="dataTable">
                        <thead class="thead-light">
                             ...
                             <tr>
                                ...
                                <!-- <th class="font-weight-bold text-dark">Comunidad Asignada</th> -->
                        ...
                        <tbody>
                            ...
                            <td class="font-weight-bold text-dark">{{ $vivienda->tipo_vivie}}</td>
                                    <td class="font-weight-bold text-dark">
                                        @if ($vivienda->persona)
                                            {{ $vivienda->persona->nombre }} {{ $vivienda->persona->apellido }}
                                        @endif
                                    </td>
                                    <!-- <td class="font-weight-bold text-dark">
                                        @if ($vivienda->comunidad)
                                            {{ $vivienda->comunidad->nom_comunas }}
                                        @endif
                                    </td> -->
                                    <td>
